...
/// Voting system with admin-controlled voter registration
///  Only registered voters can vote. Owner registers voters.
contract VotingWithRegistration {
    ...
    ///  Constructor sets the contract owner and adds initial candidates.
    ///  Array of candidate names (e.g., ["Vincent","Junior","Ruto"])
    ...
    ///  Allows the owner to add a new candidate after deployment.
    ...
    ///  Owner registers a voter by their Ethereum address.
    /// voter The address to register.
    ...
    ///  Owner can register multiple voters at once.
    /// oters Array of addresses to register.
    ...
    /// Cast a vote for a specific candidate. Only registered voters can vote.
    /// candidateIndex The index of the candidate in the `candidates` array.
